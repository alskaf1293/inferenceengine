// ======================================================================
// tb_supervised_file_trace.sv
//
// File-driven deterministic supervised learning trace. Each input row is:
...
module tb_supervised_file_trace #(
  parameter int K0 = 2,
  parameter int K1 = 16,
  parameter int K2 = 4,
  parameter int NUM_SAMPLES = 16,
  parameter int MAX_K = 16,
  parameter int MAX_SAMPLES = 128
);
  ...
  initial begin
    ...
    data_path = "runs/frozen_env_trace.dat";
    out_path = "runs/supervised_file_trace.csv";
