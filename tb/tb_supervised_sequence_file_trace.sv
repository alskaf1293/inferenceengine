// ======================================================================
// tb_supervised_sequence_file_trace.sv
//
// Persistent multi-update trace. The DATA file is flat rows ordered by update:
//   x[0] ... x[K2-1] y[0] ... y[K0-1]
// for UPDATES * SAMPLES_PER_UPDATE rows total.
// ======================================================================
...
module tb_supervised_sequence_file_trace #(
  parameter int K0 = 2,
  parameter int K1 = 16,
  parameter int K2 = 4,
  parameter int UPDATES = 4,
  parameter int SAMPLES_PER_UPDATE = 12,
  parameter int MAX_K = 16,
  parameter int MAX_TOTAL_SAMPLES = 512
);
  ...
  initial begin
    ...
    data_path = "runs/runner_sequence_flat.dat";
    out_path = "runs/supervised_sequence_file_trace.csv";
